...
for each day of the week. Create a list of moods such as "Happy", "Sad", "Energetic", 
and "Calm". Using the range() function, loop through every day of the week and for each day, 
randomly select a mood from the list and print it. Ensure that your program includes the use of 
...
for day in range(len(days_of_the_week)):
    print(f"The mood of the {days_of_the_week[day]} is {random.choice(moods)}")
